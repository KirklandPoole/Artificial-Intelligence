...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        # Added concrete Action objects based on the domain action schema for: Load, Unload, and Fly
        ...
        def load_actions():
            ...
            Logic modelled after fly_actions()
    ...
    def actions(self, state: str) -> list:
        ...
        ''' Logic modelled after actions(self, state: str) -> list: found in example_have_cake.py'''
        kb = PropKB()
